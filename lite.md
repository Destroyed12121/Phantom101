Build a single-file lite version of Phantom
...
this will only contain html and search will use https://phantomsearch.surge.sh/embed.html#https://
this will be a completely single file project that contains everything in the local files except /staticsjv2
### Prerequisites
- Node.js installed
