...
*** fix the proxy  SOON! *** done thrice btw
...
***add image and  video support for backgrounds ** SOON! *** done
***fix aichat, make the title use the same ai request as the users question unless its in image mode where it will use text mode and fix ai chat to remember modes better SOON! *** done
...
***make announcements show even on first visit unlike changelog and allow disabling it via settings*** done
***fix leave comformation asking u to leave each time you click something*** done
...
**make the only song in music be lebron lebron lebron james SOON!**
