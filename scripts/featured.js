...
let featuredGames = [
    ...
    { name: 'Slope', img: 'i gotta simplify this code someday', gameName: 'Slope' },
    { name: 'Subway Surfers', img: 'i gotta simplify this code someday', gameName: 'Subway Surfers' },
    { name: 'Run 3', img: 'i gotta simplify this code someday', gameName: 'Run 3' },
    { name: 'Basket Random', img: 'i gotta simplify this code someday', gameName: 'Basket Random' },
    { name: 'Drift Hunters', img: 'i gotta simplify this code someday', gameName: 'Drift Hunters' },
    { name: 'Moto X3M', img: 'i gotta simplify this code someday', gameName: 'Moto X3M' },
